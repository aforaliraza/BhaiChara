...
<!-- Modal -->
<div class="modal fade" id="addintercityride" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add Inter City Ride</h5>
      ...
      <div class="form-group">
        ...
        <label>Seats Capacity</label>
            <input type="number" name="seats_capacity" class="form-control" placeholder="Seats Capacity" min="1" required>
        <label>Roles</label>
            ...
            if (isset($_GET['searchbtn'])) {
                ...
                if($searchif == true){
                    // retrieve selected results from database and display them on page
                     $sql = " SELECT sr_no, mobile_no, source, destination, car_type, car_number, seats_capacity, roles, date, time, status 
                     FROM inter_city_rides 
                  ...
                  $searchif = false;
                      $sql = " SELECT sr_no, mobile_no, source, destination, car_type, car_number, seats_capacity, roles, date, time, status 
                      FROM inter_city_rides LIMIT " . $this_page_first_result . ',' .  $results_per_page;                        
                }
...
<!-- Button trigger modal -->
    <div class="card shadow mb-4">
         <div class="card-header py-3">
           <h5 class="modal-title" id="exampleModalLabel"><a href="intercityridesreg.php "> Inter City Ride </a>
             <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#addintercityride">
             Add Inter City Ride
            </button>
            <form action="intercityridesreg.php" method="GET" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            <div class="input-group">
              <input type="text" class="form-control bg-light border-0 small"  name = "search"placeholder="MNo - Role - Status" aria-label="Search" aria-describedby="basic-addon2">
            ...
            <?php
                  if($searchif == false){
                    ...
                    echo  ' <a href="intercityridesreg.php?page=' . $page . '" class="btn btn-success">' . $page . '</a>';         
                      } 
                  }
                  else{}
                  ?>
            ...
            <table class="table table-borderee" id="dataTable" width="100" collspacing="0" >
                ...
                <?php
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="intercityridesedit.php" method="POST">

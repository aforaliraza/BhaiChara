        ...
        ?>
           ...
           $results_per_page = 10;
            ...
            if (isset($_GET['searchbtn'])) {
                ...
                FROM transaction_history WHERE  mobile_number = '$search'";
                ...
                if($searchif == true){
                    ...
                    $sql = "SELECT sr_no, mobile_number, amount FROM transaction_history WHERE  mobile_number LIKE '$search%' OR amount LIKE '$search%'";
                }
                else{
...
<!-- Button trigger modal -->
    <div class="card shadow mb-4">
         <div class="card-header py-3">
           <h5 class="modal-title" id="exampleModalLabel"> Transaction History
             <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#addtransactionhistory">
             Add Transaction History
            </button>
            <form action="deletereg.php" method="GET" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            <div class="input-group">
              <input type="text" class="form-control bg-light border-0 small"  name = "search"placeholder="Search for(M No or Amount)... " aria-label="Search" aria-describedby="basic-addon2">
            ...
            <div>
                ...
                if($searchif == false){
                   ...
                   echo  ' <a href="deletereg.php?page=' . $page . '" class="btn btn-success">' . $page . '</a>';         
                    } 
                }
                else{}
                ?>    
